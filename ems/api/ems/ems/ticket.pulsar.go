...
func init() {
	...
	md_Ticket = File_ems_ems_ticket_proto.Messages().ByName("Ticket")
...
func (x *Ticket) slowProtoReflect() protoreflect.Message {
	mi := &file_ems_ems_ticket_proto_msgTypes[0]
...
func (x *fastReflection_Ticket) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ems.ems.Ticket.eventid":
		return x.Eventid != uint64(0)
	case "ems.ems.Ticket.owner":
		return x.Owner != ""
	case "ems.ems.Ticket.creator":
		return x.Creator != ""
	case "ems.ems.Ticket.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ems.ems.Ticket"))
		}
		panic(fmt.Errorf("message ems.ems.Ticket does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Ticket) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ems.ems.Ticket does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Ticket) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ems.ems.Ticket.eventid":
		panic(fmt.Errorf("field eventid of message ems.ems.Ticket is not mutable"))
	case "ems.ems.Ticket.owner":
		panic(fmt.Errorf("field owner of message ems.ems.Ticket is not mutable"))
	case "ems.ems.Ticket.creator":
		panic(fmt.Errorf("field creator of message ems.ems.Ticket is not mutable"))
	case "ems.ems.Ticket.id":
		panic(fmt.Errorf("field id of message ems.ems.Ticket is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ems.ems.Ticket"))
		}
...
func (x *fastReflection_Ticket) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ems.ems.Ticket", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Ticket) Descriptor() ([]byte, []int) {
	return file_ems_ems_ticket_proto_rawDescGZIP(), []int{0}
}
...
var File_ems_ems_ticket_proto protoreflect.FileDescriptor

var file_ems_ems_ticket_proto_rawDesc = []byte{
	0x0a, 0x14, 0x65, 0x6d, 0x73, 0x2f, 0x65, 0x6d, 0x73, 0x2f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x65, 0x6d, 0x73, 0x2e, 0x65, 0x6d, 0x73, 0x22,
	0x62, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01,
	...
	0x02, 0x69, 0x64, 0x42, 0x68, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x73, 0x2e, 0x65,
	0x6d, 0x73, 0x42, 0x0b, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_ems_ems_ticket_proto_rawDescOnce sync.Once
	file_ems_ems_ticket_proto_rawDescData = file_ems_ems_ticket_proto_rawDesc
)

func file_ems_ems_ticket_proto_rawDescGZIP() []byte {
	file_ems_ems_ticket_proto_rawDescOnce.Do(func() {
		file_ems_ems_ticket_proto_rawDescData = protoimpl.X.CompressGZIP(file_ems_ems_ticket_proto_rawDescData)
	})
	return file_ems_ems_ticket_proto_rawDescData
}

var file_ems_ems_ticket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ems_ems_ticket_proto_goTypes = []interface{}{
	(*Ticket)(nil), // 0: ems.ems.Ticket
}
var file_ems_ems_ticket_proto_depIdxs = []int32{
...
func init() { file_ems_ems_ticket_proto_init() }
func file_ems_ems_ticket_proto_init() {
	if File_ems_ems_ticket_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ems_ems_ticket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ticket); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ems_ems_ticket_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ems_ems_ticket_proto_goTypes,
		DependencyIndexes: file_ems_ems_ticket_proto_depIdxs,
		MessageInfos:      file_ems_ems_ticket_proto_msgTypes,
	}.Build()
	File_ems_ems_ticket_proto = out.File
	file_ems_ems_ticket_proto_rawDesc = nil
	file_ems_ems_ticket_proto_goTypes = nil
	file_ems_ems_ticket_proto_depIdxs = nil
}
